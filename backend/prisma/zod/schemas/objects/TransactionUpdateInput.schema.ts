...
import { UserUpdateOneRequiredWithoutTransactionsNestedInputObjectSchema as UserUpdateOneRequiredWithoutTransactionsNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutTransactionsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  user: z.lazy(() => UserUpdateOneRequiredWithoutTransactionsNestedInputObjectSchema).optional()
}).strict();
export const TransactionUpdateInputObjectSchema: z.ZodType<Prisma.TransactionUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.TransactionUpdateInput>;
export const TransactionUpdateInputObjectZodSchema = makeSchema();
