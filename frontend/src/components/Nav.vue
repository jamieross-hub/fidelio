...
import { mdiCardsOutline, mdiFinance, mdiPlusOutline } from "@mdi/js";
import SvgIcon from "@jamescoyle/vue-icon";
import { RouterLink } from "vue-router";
</script>

<template>
    <nav class="flex h-17.5 justify-between items-center px-5 sm:px-10 py-5 gap-5 shadow-md bg-white z-50">
